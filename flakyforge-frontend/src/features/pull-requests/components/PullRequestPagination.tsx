import type { PullRequestsResponse } from "../../../api/pullRequestApi";
import { Button } from "../../../components/Button";

type PullRequestPaginationProps = {
  pagination: PullRequestsResponse["pagination"];
  actualCount: number;
  onPageChange: (page: number) => void;
};

export function PullRequestPagination({
  pagination,
  actualCount,
  onPageChange,
}: PullRequestPaginationProps) {
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="text-[#94A3B8] text-[13px]">
        Showing {actualCount} of {pagination.total} pull requests
      </div>
