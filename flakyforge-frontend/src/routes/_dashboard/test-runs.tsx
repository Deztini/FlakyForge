      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-[#1A1D27] border border-[#1E2139] rounded-xl p-5">
            <div className="text-[#94A3B8] text-[13px] mb-2">Total Runs</div>
            <div className="text-white text-[32px] font-bold">847</div>
          </div>

          <div className="bg-[#1A1D27] border border-[#1E2139] rounded-xl p-5">
            <div className="text-[#94A3B8] text-[13px] mb-2">Runs Today</div>
            <div className="text-white text-[32px] font-bold">8</div>
          </div>

          <div className="bg-[#1A1D27] border border-[#1E2139] rounded-xl p-5">
            <div className="text-[#94A3B8] text-[13px] mb-2">Success Rate</div>
            <div className="text-white text-[32px] font-bold">87%</div>
          </div>

          <div className="bg-[#1A1D27] border border-[#1E2139] rounded-xl p-5">
            <div className="text-[#94A3B8] text-[13px] mb-2">Avg Duration</div>
            <div className="text-white text-[32px] font-bold">4m 12s</div>
          </div>
        </div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className="text-white text-[16px] font-semibold">{run.repository}</h3>
                    <span className="px-2.5 py-0.5 bg-[#0F1117] border border-[#2D3148] rounded-full text-[#94A3B8] text-[11px]">
                      {run.branch}
                    </span>
                    <span className={`flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] capitalize ${getStatusBadgeColors(run.statusColor)}`}>
              ...
              <div className="grid grid-cols-2 md:grid-cols-6 gap-4 pt-4 border-t border-[#1E2139]">
                ...
                <div>
                  ...
                  <div className="text-white text-[13px]">{run.totalTests.toLocaleString()}</div>
                </div>
                <div>
                  <div className="text-[#94A3B8] text-[11px] mb-1">Passed</div>
                  <div className="text-[#22C55E] text-[13px] font-semibold">{run.passed.toLocaleString()}</div>
                </div>
                <div>
                  <div className="text-[#94A3B8] text-[11px] mb-1">Flaky</div>
                  <div className="text-[#F59E0B] text-[13px] font-semibold">{run.flaky}</div>
                </div>
              </div>
            </div>
          ))}
