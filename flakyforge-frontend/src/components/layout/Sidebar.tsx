...
const navItems = [
  ...
  { icon: FolderGit2,      label: 'Repositories',  path: '/repositories',  badge: null },
  { icon: AlertCircle,     label: 'Flaky Tests',   path: '/flaky-tests',   badge: '12' },
  { icon: PlayCircle,      label: 'Test Runs',     path: '/test-runs',     badge: null },
  { icon: GitPullRequest,  label: 'Pull Requests', path: '/pull-requests', badge: null },
...
function NavItem({ icon: Icon, label, path, badge }: typeof navItems[number]) {
